...
3. If a quota handoff happened (see `docs/continuity_prompt.md`), also save
   that conversation as `trajectories/<other-model>-handoff-<phase>.md`,
   and note the handoff in the README's "Tools disclosed" section.
